...
export default function ContactPage() {
  ...
  <div className="mt-16 w-full max-w-md rounded-xl bg-[#fdf6ee] p-8 shadow-xl border border-border">
        <div className="flex flex-col items-center justify-center space-y-4 mb-8">
          ...
          <p className="w-full text-xl text-muted-foreground max-w-3xl text-center">
            Have a question, suggestion, or want to get in touch? Fill out the form below and our team will respond as soon as possible.
          </p>
        </div>
